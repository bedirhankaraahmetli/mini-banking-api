...
public class SecurityConfig {
    ...
    public PasswordEncoder passwordEncoder() {
        return new BCryptPasswordEncoder(); // Industrial-strength password encoder that uses the BCrypt hashing
                                            // function. It is a widely used and secure way to hash passwords in Java
                                            // applications.
    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        http // Configures the HttpSecurity object to define security settings for the
             // application.
                .csrf(AbstractHttpConfigurer::disable) // Disables Cross-Site Request Forgery (CSRF) protection. This is
                                                       // often done in stateless applications or APIs where CSRF
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/v1/auth/**", "/api/v1/customers", "/v3/api-docs/**", "/swagger-ui/**")
                        .permitAll()
